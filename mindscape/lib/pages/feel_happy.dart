...
class FeelHappy extends StatefulWidget {
  const FeelHappy({Key? key}) : super(key: key);

  @override
  _FeelHappyState createState() => _FeelHappyState();
}

class _FeelHappyState extends State<FeelHappy> {
  int currentIndex = 0;
